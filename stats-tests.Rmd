...
ggsave(filename = "images/p_oth.svg", plot = p_oth, device="svg", height=7, width=7, units="in")
```
# glm glass
...
svg(file = "images/MDS_veg.svg",   # The directory you want to save the file in
...
ggsave(filename = "images/MDS_ec.svg", plot = MDS_ec, device="svg", height=7, width=11, units="in")
