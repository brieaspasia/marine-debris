...
m2  <- glmmTMB(Total ~ #Debris count
                 Fishing*Location*Habitat + #predicted by Habitat (fishing or non-fishing)
                 Fishing*Location*Coast + #predicted by distance from mouth (fishing or non-fishing)
                 (1|Date), #date random effect
...
m_disp  <- glmmTMB(Total ~ #Debris count
                 Dispersiveness*Location*Habitat + #predicted by Habitat (dispersiveness)
                 Dispersiveness*Location*Coast + #predicted by distance from mouth (dispersiveness)
                 (1|Date), #site random effect
                 # (1|Dispersiveness) + #dispersiveness random effect
                 # ar1(Date + 0 | Location) +
                 # offset(log(NumberSurveys)), #offset by survey count
               # zi = ~1, #zero inflation
...
m_F2  <- glmmTMB(Total ~ #Debris count
                 Location*Habitat + #predicted by Habitat (dispersiveness)
                 Location*Coast + #predicted by distance from mouth (dispersiveness)
                 (1|Date), #site random effect
                 # (1|Dispersiveness) + #dispersiveness random effect
                 # ar1(Date + 0 | Location) +
                 # offset(log(NumberSurveys)), #offset by survey count
...
simulationOutput <- simulateResiduals(fittedModel = m_F2, plot=T)
...
# testGeneric(simulationOutput, summary = means) #test if a generic summary statistics deviates from model expectations
