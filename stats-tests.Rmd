...
#                family=nbinom(), #negative binomial to deal with count data and zeros
#                data = mod_hab)
...
drop1(m_hab1, test = "Chisq")

AIC(m_hab1, m_hab2, m_hab3, m_hab4) #but AIC shows less than 2 pts difference with or without coast so choose the model with less terms, but DHARMa dispersion is significant without coast, so keep all three
