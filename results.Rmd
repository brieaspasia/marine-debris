...
p_top_items <- 
  ggplot(top_items, aes(x=sum, y=item_name, colour=Material)) +
  geom_point() +        
  geom_segment( aes(x=0, xend=sum, y=item_name, yend=item_name))
...
p_hab_top_items <- 
  ggplot(top_items, aes(x=sum, y=item, colour=)) +
  geom_point() +        
