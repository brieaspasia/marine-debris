...
lib.load = c("here", "ggplot2", "dplyr", "lubridate", "forcats", "ggthemes", "knitr", "kableExtra", "stats") 
...
```
```{r glm}
m1 <- glm( Total ~ Habitat, data = site_select, family = poisson)
summary(m1)

m2 <- glm( Total ~ Fishing, data = site_select, family = poisson)
summary(m2)
```
