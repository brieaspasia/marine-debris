...
lib.load = c("here", "ggplot2", "dplyr", "lubridate", "forcats", "ggthemes", "knitr", "kableExtra", "stats", "broom", "hrbrthemes") 
...
top20items <- kable(top_items, "html", 
      col.names = c("ID", "Material", "Sum", "SD", "Name"),
