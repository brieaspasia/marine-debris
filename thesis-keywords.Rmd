...
NetMatrix <- biblioNetwork(bib.71, n=20, analysis = "co-occurrences", network = "author_keywords", sep = ";") #create keyword network
...
load(file = "./data/bib_11.RData") #load the bibliometrix object
      ...
      #create sparse matrix
      NetMatrix <- biblioNetwork(bib.11, n=50, analysis = "co-occurrences", network = "author_keywords", sep = ";")
