...
fit_4th <- gllvm(y, X, TR, family = "negative.binomial", num.lv = 2, 
                ...
                (Habitat + DistKm) : (Dispersiveness + 
                Fishing), seed = 123,
                row.eff = "random", n.init = 3, jitter.var = 0.01,
                randomX = ~ Habitat + DistKm)
...
fit_4th <- gllvm(y, X, TR, family = "negative.binomial", num.lv = 2, 
                 formula = y ~ (Habitat + DistKm) +
                (Habitat + DistKm + Location) : (Dispersiveness + 
                Fishing + Material), seed = 123,
                row.eff = "random", n.init = 3, jitter.var = 0.01,
                randomX = ~ Habitat + DistKm + Location)
...
#call svg command to start the plot
svg(file = "images/coefplot_4th.svg",   # The directory you want to save the file in
    width = 11, # The width of the plot in inches
    height = 7) # The height of the plot in inches
coefplot(fit_4th)
dev.off()
